%% Image From Urns (Proportional Method)
...
function image = image_from_urns_proportional(image_size, urns)
...
%         
        for i = 1:image_size(1)
           for j = 1:image_size(2)
              ...
              % Get percentage white balls for each urn and convert value
              % to greyscale.
              image(i,j) = ceil(thisRow(2)/(thisRow(1)+thisRow(2))*255);
